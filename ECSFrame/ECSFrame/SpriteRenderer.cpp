...
SpriteRenderer::Data SpriteRenderer::m_data;
std::shared_ptr<VertexShader> SpriteRenderer::m_defVS;
std::shared_ptr<PixelShader> SpriteRenderer::m_defPS;
std::shared_ptr<Texture> SpriteRenderer::m_whiteTex;
...
{
	m_data.param[1].w = scale.x;
	m_data.param[1].z = scale.y;
}
...
void SpriteRenderer::SetWorld(DirectX::XMFLOAT4X4 world)
{
	m_data.matrix[0] = world;
}
void SpriteRenderer::SetView(DirectX::XMFLOAT4X4 view)
{
	m_data.matrix[1] = view;
}
void SpriteRenderer::SetProjection(DirectX::XMFLOAT4X4 proj)
{
	m_data.matrix[2] = proj;
}
void SpriteRenderer::SetVertexShader(Shader* vs)
{
...
void SpriteRenderer::SetPixelShader(Shader* ps)
{
